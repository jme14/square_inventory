...
GAME_CATAGORY_ID = "PEDVXQTFWX7G3RRW234W4X3A"
...
if __name__ == "__main__":
    ...
    game_products = [product for product in products if GAME_CATAGORY_ID == product.get_category_id() and product.is_to_sold()]
